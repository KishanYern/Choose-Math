    ...
    <div className="min-h-screen bg-slate-950">
      ...
      <div className="border-b border-slate-800 bg-slate-900/40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
          <p className="text-indigo-400 text-xs font-medium uppercase tracking-widest mb-3">Stories</p>
      ...
      <div className="border-t border-slate-800 bg-slate-900/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <h2 className="text-xl font-semibold text-slate-100 mb-6">Common Threads</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {[
              ...
              <div key={item.title} className="p-5 rounded-xl border border-slate-800 bg-slate-900/50">
                <span className="text-2xl math-symbol text-indigo-400/50 font-light block mb-3">
                  {item.symbol}
                </span>
                <h3 className="text-slate-300 font-semibold text-sm mb-1.5">{item.title}</h3>
      ...
      {/* CTA */}
      <div className="border-t border-slate-800 py-16 text-center px-4">
